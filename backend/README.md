...
## Project Structure
    ...
    ├── testapiautostoryboa_57819  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_57819`
...
2. Clone this repo and `cd testapiautostoryboa_57819`
